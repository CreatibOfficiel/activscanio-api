...
export class AddOnboardingAndSeasons1764184949000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_bettor_rankings_rank"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_bettor_rankings_year_month"`);

        // Remove foreign key and column from betting_weeks
        await queryRunner.query(`ALTER TABLE "betting_weeks" DROP CONSTRAINT IF EXISTS "FK_betting_weeks_season"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_betting_weeks_season"`);
        await queryRunner.query(`ALTER TABLE "betting_weeks" DROP COLUMN "seasonArchiveId"`);

        // Remove indexes and columns from users
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_competitor_id_unique"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_boost_tracking"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "hasCompletedOnboarding"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "lastBoostUsedYear"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "lastBoostUsedMonth"`);

        // Drop archived_competitor_rankings table (with foreign key)
        await queryRunner.query(`ALTER TABLE "archived_competitor_rankings" DROP CONSTRAINT IF EXISTS "FK_archived_competitor_rankings_season"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_archived_competitor_rankings_competitor"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_archived_competitor_rankings_season"`);
        await queryRunner.query(`DROP TABLE "archived_competitor_rankings"`);

        // Drop season_archives table
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_season_archives_year"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_season_archives_month_year"`);
